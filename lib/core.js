...
class Core {
    constructor(config) {
        ...
        this._config.assetsFolder = this._config.assets || './static';
    ...
    _copyAssets() {
        fs.copy(this._config.assetsFolder, this._config.outputFolder);
    }
    ...
    init() {
        if(!this._errored()) {
            ...
            if(this._config.debug) {
                console.log(JSON.stringify(this._generateModel(), undefined, 4));
            }

            fs.emptyDir(this._config.outputFolder, () => {
